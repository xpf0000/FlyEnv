...
[FlyEnv-4.8.0.dmg](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.0/FlyEnv-4.8.0.dmg)

[FlyEnv-4.8.0-mac.zip](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.0/FlyEnv-4.8.0-mac.zip)

### Apple Silicon

[FlyEnv-4.8.0-arm64.dmg](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.0/FlyEnv-4.8.0-arm64.dmg)

[FlyEnv-4.8.0-arm64-mac.zip](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.0/FlyEnv-4.8.0-arm64-mac.zip)
