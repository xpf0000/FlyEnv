...
- [FlyEnv-4.9.2-mac.zip](https://github.com/xpf0000/FlyEnv/releases/download/v4.9.2/FlyEnv-4.9.2-mac.zip)

#### Apple Silicon (ARM64)
- [FlyEnv-4.9.2-arm64.dmg](https://github.com/xpf0000/FlyEnv/releases/download/v4.9.2/FlyEnv-4.9.2-arm64.dmg)
- [FlyEnv-4.9.2-arm64-mac.zip](https://github.com/xpf0000/FlyEnv/releases/download/v4.9.2/FlyEnv-4.9.2-arm64-mac.zip)
