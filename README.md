...
[FlyEnv-4.8.1.dmg](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.1/FlyEnv-4.8.1.dmg)

[FlyEnv-4.8.1-mac.zip](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.1/FlyEnv-4.8.1-mac.zip)

### Apple Silicon

[FlyEnv-4.8.1-arm64.dmg](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.1/FlyEnv-4.8.1-arm64.dmg)

[FlyEnv-4.8.1-arm64-mac.zip](https://github.com/xpf0000/FlyEnv/releases/download/v4.8.1/FlyEnv-4.8.1-arm64-mac.zip)
