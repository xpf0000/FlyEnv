<template>
  <el-form :model="form" label-position="top">
    ...
    <el-form-item label="Password">
      <el-input v-model="form.environment.MEILI_MASTER_KEY" placeholder="REDIS_PASSWORD"></el-input>
    </el-form-item>
...
<script lang="ts" setup>
  ...
  const formName = 'Meilisearch'
  const image = OfficialImages.meilisearch?.image ?? ''

  const form = computed(() => {
    return ComposeBuildForm.Meilisearch
  })
</script>
