        ...
        <el-scrollbar v-if="ClaudeCodeSetup.mcpServers.length > 0">
          <el-table :data="ClaudeCodeSetup.mcpServers" style="width: 100%" show-overflow-tooltip>
            <el-table-column width="180">
              <template #header>
                <div class="w-full min-w-0 truncate">{{ I18nT('claudeCode.mcpName') }}</div>
              </template>
            ...
            <el-table-column width="100">
              <template #header>
                <div class="w-full min-w-0 truncate">{{ I18nT('claudeCode.mcpType') }}</div>
              </template>
              <template #default="{ row }">
            ...
            <el-table-column>
              <template #header>
                <div class="w-full min-w-0 truncate">
                  {{ I18nT('claudeCode.mcpCommandOrUrl') }}
                </div>
              </template>
              <template #default="{ row }">
