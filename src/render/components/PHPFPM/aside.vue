<template>
  <li
    v-if="showItem"
    :class="'non-draggable' + (currentPage === '/php-fpm' ? ' active' : '')"
    @click="nav"
  >
    <div class="left">
...
<script lang="ts" setup>
  ...
  const { showItem, currentPage, nav, stopNav } = AsideSetup('php-fpm')
