...
export function nodeToSVG(node: HTMLElement, width: number, height: number): SVGElement {
  ...
  foreignObject.style.textRendering = 'geometricPrecision'
...
export async function nodeToDataURL(
  ...
  return svgToDataURL(nodeToSVG(node, width, height))
}
