...
4. Implement only after the owner, terminal events, and tests are explicit.
...
| Selected versions, installed lists, settings    | Pinia or an established module store |
