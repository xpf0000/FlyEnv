...
async function main() {
  await call('list_config_files', { flag: 'nginx' })
  await call('list_log_files', { flag: 'nginx' })
  await call('list_config_files', { flag: 'php' })
  await call('list_log_files', { flag: 'php' })
  await call('list_config_files', { flag: 'mysql' })
  await call('list_log_files', { flag: 'mysql' })
}
