...
<script lang="ts" setup>
  ...
  import PortVM from '@web/components/VersionManager/port/index.vue'
  import BrewVM from '@web/components/VersionManager/brew/index.vue'
  import StaticVM from '@web/components/VersionManager/static/index.vue'
  import LocalVM from '@web/components/VersionManager/local/index.vue'
